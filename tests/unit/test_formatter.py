...
def test_format_movie_details():
    data = {'genre': 'Action', 'country': 'USA', 'duration': '02:00', 'director': 'Wachowski', 'actors': 'Keanu Reeves'}
...
def test_format_technical_details():
    data = {'quality': '1080p', 'audio': ['Russian', 'English'], 'subtitles': 'Russian'}
...
def test_format_torrent_message_full():
    ...
    data = {'title': 'Inception', 'quality': 'BDRip', 'imdb_url': 'http://imdb.com/1'}
