...
def test_select_best_torrent_full(mock_film):
    t1 = Torrent(name="Matrix 1080p", sz=10**10, film_id=1, magnet="m1", blake="bl1", created=date.today(), link="l1")
    t2 = Torrent(name="Matrix 4K", sz=5 * 10**10, film_id=1, magnet="m2", blake="bl2", created=date.today(), link="l2")
    ...
    t3 = Torrent(name="Matrix LostFilm", sz=10**10, film_id=1, magnet="m3", blake="bl3", created=date.today(), link="l3")
...
def test_find_relevant_torrents_full(mock_film):
    t1 = Torrent(name="The Matrix Bluray", sz=10**9, film_id=1, magnet="m", blake="bl1", created=date.today(), link="l1")
    t2 = Torrent(name="Avatar", sz=10**9, film_id=1, magnet="m2", blake="bl2", created=date.today(), link="l2")
