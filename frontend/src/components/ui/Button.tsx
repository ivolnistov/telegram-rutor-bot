...
export const Button = ({
    ...
    const baseStyles = "font-medium transition-colors flex items-center justify-center gap-2 rounded-lg outline-none focus:ring-2 focus:ring-offset-1 focus:ring-offset-zinc-950 disabled:opacity-50 disabled:cursor-not-allowed"

    const variants = {
        primary: "bg-violet-600 hover:bg-violet-700 text-white focus:ring-violet-500",
        secondary: "bg-zinc-800 hover:bg-zinc-700 text-zinc-200 focus:ring-zinc-500",
